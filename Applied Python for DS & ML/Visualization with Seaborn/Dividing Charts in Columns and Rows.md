...
```
    ...
    <seaborn.axisgrid.FacetGrid at 0x20d59711d90>
...
```
    ...
    <seaborn.axisgrid.FacetGrid at 0x20d57692d90>
...
```
    ...
    <seaborn.axisgrid.FacetGrid at 0x20d5c06cf40>
...
### Divinding Charts in Columns and Rows 


```python
sns.catplot(x="class",y="fare",kind="violin",data=titanic,row="survived")
```




    <seaborn.axisgrid.FacetGrid at 0x20d573c2460>
...
```python
sns.catplot(x="class",y="fare",kind="violin",data=titanic,col="survived")
```




    <seaborn.axisgrid.FacetGrid at 0x20d5c1aafa0>
